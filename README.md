[![Run App Schaefer, Thomas](https://github.com/toschaef/GithubActions-practice/actions/workflows/run-app.yaml/badge.svg)](https://github.com/toschaef/GithubActions-practice/actions/workflows/run-app.yaml)
